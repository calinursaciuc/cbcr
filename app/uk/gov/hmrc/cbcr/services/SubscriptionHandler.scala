...
@Singleton
class SubscriptionHandlerImpl @Inject()(cbcrIdConfig: CbcrIdConfig, localCBCIdGenerator: LocalSubscription, remoteCBCIdGenerator: RemoteSubscription) extends SubscriptionHandler {

  val useDESApi: Boolean = cbcrIdConfig.useDESApi
